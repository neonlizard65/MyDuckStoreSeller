...
namespace MyDuckStoreSeller.Classes.Instances
{
    ...
    public class CpuInstance : Instance
    {
        ...
        public CpuInstance(string CpuInstanceID, string CpuId, string SerialNumber, string SellerId, string InstanceId, string Sold) : base(SellerId, InstanceId, Sold, SerialNumber)
        {
