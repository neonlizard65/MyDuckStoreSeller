...
namespace MyDuckStoreSeller.Classes.Instances
{
    ...
    public class MouseInstance : Instance
    {
        ...
        public MouseInstance(string MouseInstanceID, string MouseId, string SerialNumber, string SellerId, string InstanceId, string Sold) : base(SellerId, InstanceId, Sold, SerialNumber)
        {
